...
function init3DObjects(camera,sceneGraph, drawingData) {
  ...
  const planeGeometry2 = primitive.Quadrangle(new THREE.Vector3(-100,-50,-50),new THREE.Vector3(100,-50,-50),new THREE.Vector3(100,-50,50),new THREE.Vector3(-100,-50,50));
  const materialGround2 = new THREE.MeshLambertMaterial({ color: 0xC0C0C0, side: THREE.DoubleSide });
  const plane2 = new THREE.Mesh(planeGeometry2,materialGround2);
  plane2.name="plane2";
